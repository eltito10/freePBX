<?php /* $Id: call-log.php 12068 2011-05-06 04:41:41Z p_lindheimer $ */
...
if (!file_exists($amp_conf['ASTETCDIR'].'/call-log-table.php') || !@include($amp_conf['ASTETCDIR'].'/call-log-table.php')) {
	...
	$FG_TABLE_COL[]=array ("Calldate", "calldate", "15%", "center", "SORT", "19");
//	$FG_TABLE_COL[]=array ("Channel", "channel", "13%", "center", "", "30", "", "", "", "", "", "display_acronym");
	$FG_TABLE_COL[]=array ("Origen", "src", "5%", "center", "", "20");
	$FG_TABLE_COL[]=array ("Clid", "clid", "10%", "center", "", "30",'','','','','','filter_html');

	$FG_TABLE_COL[]=array ("Destino", "dst", "14%", "center", "", "30");
	//$FG_TABLE_COL[]=array ("Context", "dcontext", "14%", "center", "", "30");
      $FG_TABLE_COL[]=array ("IdDeudor", "deudor", "10%", "center", "", "30");
      $FG_TABLE_COL[]=array ("Negocio", "negocio", "10%", "center", "", "30");
      $FG_TABLE_COL[]=array ("CodGestion", "gstcodigo", "10%", "center", "", "30");
      $FG_TABLE_COL[]=array ("Contacto", "gstcontacto", "10%", "center", "", "30");
      $FG_TABLE_COL[]=array ("IdEmpresa", "idempresa", "10%", "center", "", "30");

	$FG_TABLE_COL[]=array ("Status", "disposition", "10%", "center", "", "20");
	if ((!isset($resulttype)) || ($resulttype=="min")) $minute_function= "display_minute";
	$FG_TABLE_COL[]=array ("Duration", "duration", "8%", "center", "SORT", "10", "", "", "", "", "", "$minute_function");
	$FG_TABLE_COL[]=array ("Billsec", "billsec", "8%", "center", "SORT", "10", "", "", "", "", "", "$minute_function");
	$FG_TABLE_COL[]=array ("Cost", "userfield", "8%", "center", "", "30");
        $FG_TABLE_COL[]=array ("", "uniqueid", "2%", "center", "", "20");
	...
	$FG_COL_QUERY='calldate, src, clid, dst, deudor, negocio,  gstcodigo, gstcontacto, idempresa ,disposition, duration, billsec, userfield, uniqueid';
...
if ($posted==1){
  ...
  $SQLcmd = do_field($SQLcmd, 'negocio'); //añadido 131011
  $SQLcmd = do_field($SQLcmd, 'deudor'); //añadido 131011
  $SQLcmd = do_field($SQLcmd, 'gstcodigo'); //añadido 131016
  $SQLcmd = do_field($SQLcmd, 'gstcontacto'); //añadido 131018
  $SQLcmd = do_field($SQLcmd, 'idempresa'); //añadido 131018
...
if (DB_TYPE == "postgres"){		
		...
		//$UNIX_TIMESTAMP = "UNIX_TIMESTAMP";//linea original
		$UNIX_TIMESTAMP = "";
}
...
if (!isset ($FG_TABLE_CLAUSE) || strlen($FG_TABLE_CLAUSE)==0){
		...
		//$FG_TABLE_CLAUSE=" $UNIX_TIMESTAMP(calldate) >= $UNIX_TIMESTAMP('$cc_yearmonth-01')";//linea original
		$FG_TABLE_CLAUSE=" calldate >= '$cc_yearmonth-01' "; //nueva linea 131016
}
...
open(pag,null,"height=300,width=400,status=yes,toolbar=no,menubar=no,location=no");
	...
	<INPUT TYPE="hidden" NAME="current_page" value=0>	
		<table class="bar-status" width="75%" border="0" cellspacing="1" cellpadding="2" align="center">
			...
			<tr>
				<td class="bar-search" align="left" bgcolor="#555577">			
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;NEGOCIO</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#cddeff">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="negocio" value="<?php echo "$negocio"?>"></td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="negociotype" value="1" <?php if((!isset($negtype))||($negtype==1)){?>checked<?php }?>>Exact</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="negociotype" value="2" <?php if($negtype==2){?>checked<?php }?>>Begins with</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="negociotype" value="3" <?php if($negtype==3){?>checked<?php }?>>Contains</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="negociotype" value="4" <?php if($negtype==4){?>checked<?php }?>>Ends with</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#000033">			
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;DEUDOR</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#acbdee">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="deudor" value="<?php echo "$deudor"?>"></td>
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="deudortype" value="1" <?php if((!isset($negtype))||($negtype==1)){?>checked<?php }?>>Exact</td>
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="deudortype" value="2" <?php if($negtype==2){?>checked<?php }?>>Begins with</td>
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="deudortype" value="3" <?php if($negtype==3){?>checked<?php }?>>Contains</td>
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="deudortype" value="4" <?php if($negtype==4){?>checked<?php }?>>Ends with</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#555577">			
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;COD GESTION</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#cddeff">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="gstcodigo" value="<?php echo "$gstcodigo"?>"></td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="gstcodigotype" value="1" <?php if((!isset($gstcodigotype))||($gstcodigotype==1)){?>checked<?php }?>>Exact</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="gstcodigotype" value="2" <?php if($gstcodigotype==2){?>checked<?php }?>>Begins with</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="gstcodigotype" value="3" <?php if($gstcodigotype==3){?>checked<?php }?>>Contains</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="gstcodigotype" value="4" <?php if($gstcodigotype==4){?>checked<?php }?>>Ends with</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#000033">			
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;CONTACTO</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#acbdee">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="gstcontacto" value="<?php echo "$gstcontacto"?>"></td>
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="gstcontactotype" value="1" <?php if((!isset($gstcontactotype))||($gstcontactotype==1)){?>checked<?php }?>>Exact</td>
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="gstcontactotype" value="2" <?php if($gstcontactotype==2){?>checked<?php }?>>Begins with</td>
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="gstcontactotype" value="3" <?php if($gstcontactotype==3){?>checked<?php }?>>Contains</td>
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="gstcontactotype" value="4" <?php if($gstcontactotype==4){?>checked<?php }?>>Ends with</td>
				</tr></table></td>
			</tr>
			<tr>
				<td class="bar-search" align="left" bgcolor="#555577">			
					<font face="verdana" size="1" color="#ffffff"><b>&nbsp;&nbsp;ID EMPRESA</b></font>
				</td>				
				<td class="bar-search" align="left" bgcolor="#cddeff">
				<table width="100%" border="0" cellspacing="0" cellpadding="0"><tr><td>&nbsp;&nbsp;<INPUT TYPE="text" NAME="idempresa" value="<?php echo "$idempresa"?>"></td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="idempresatype" value="1" <?php if((!isset($idempresatype))||($idempresatype==1)){?>checked<?php }?>>Exact</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="idempresatype" value="2" <?php if($idempresatype==2){?>checked<?php }?>>Begins with</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="idempresatype" value="3" <?php if($idempresatype==3){?>checked<?php }?>>Contains</td>
				<td class="bar-search" align="center" bgcolor="#cddeff"><input type="radio" NAME="idempresatype" value="4" <?php if($idempresatype==4){?>checked<?php }?>>Ends with</td>
				</tr></table></td>
			</tr>
<!-- AMP			<tr>
				<td class="bar-search" align="left" bgcolor="#555577">				
...
-->
			<tr>
				...
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="duration1type" value="5" <?php if($duration1type==5){?>checked<?php }?>>&gt; egal</td>
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="duration1type" value="1" <?php if((!isset($duration1type))||($duration1type==1)){?>checked<?php }?>>Egal</td>
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="duration1type" value="2" <?php if($duration1type==2){?>checked<?php }?>>&lt; egal</td>
				...
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="duration2type" value="5" <?php if($duration2type==5){?>checked<?php }?>>&gt; egal</td>								
				<td class="bar-search" align="center" bgcolor="#acbdee"><input type="radio" NAME="duration2type" value="2" <?php if($duration2type==1){?>checked<?php }?>>&lt; egal</td>
			...
			<tr>
        		<td class="bar-search" align="left" bgcolor="#555577">
                   <img border="0" src="cdr/images/icono_descarga.png" width="20" height="20" align="right" onclick =  "abrirventanaflotante('../aga/soloDescarga.php?where=<?php echo urlencode($FG_TABLE_CLAUSE)  ?>') ">
        	    </td>
...
<TBODY>
                <TR bgColor=#F0F0F0> 
                  ...
                  <TD width="<?php echo $FG_TABLE_COL[$i][2]?>" align=middle class="tableBody" style="PADDING-BOTTOM: 2px; PADDING-LEFT: 2px; PADDING-RIGHT: 2px; PADDING-TOP: 2px"> 
                    ...
                    <a href="<?php  echo $_SERVER['PHP_SELF']."?handler=cdr&s=1&t=$t&stitle=$stitle&atmenu=$atmenu&current_page=$current_page&order=".$FG_TABLE_COL[$i][1]."&sens="; if ($sens=="ASC"){echo"DESC";}else{echo"ASC";}

					echo "&posted=$posted&Period=$Period&frommonth=$frommonth&fromstatsmonth=$fromstatsmonth&tomonth=$tomonth&tostatsmonth=$tostatsmonth&fromday=$fromday&fromstatsday_sday=$fromstatsday_sday&fromstatsmonth_sday=$fromstatsmonth_sday&today=$today&tostatsday_sday=$tostatsday_sday&tostatsmonth_sday=$tostatsmonth_sday&dsttype=$dsttype&srctype=$srctype&clidtype=$clidtype&channel=$channel&resulttype=$resulttype&dst=$dst&src=$src&clid=$clid&userfieldtype=$userfieldtype&userfield=$userfield&accountcodetype=$accountcodetype&accountcode=$accountcode&duration1=$duration1&duration1type=$duration1type&duration2=$duration2&duration2type=$duration2type&negocio=$negocio&negociotype=$negociotype&deudor=$deudor&deudortype=$deudortype&gstcodigo=$gstcodigo&codigotype=$codigotype";?>">
				...
				?>
						...
						$record[$i]= stripslashes($record_display);
						//$record[$i]= str_replace(' ', '_', $record_display);
						if ($i < 10)
						echo $record[$i];
						 }						 
						 ?></TD>
				 		 <?php  } echo "<td><a href=audio.php?uid=$record[13]&dia=$record[0]><IMG border=0 src='images/sound.png'></a></td>";?>
